...
bool MapLayer::init() {
	...
	currentMap = maps[0];
	setMap(VILLAGE);
	ch = CharacterAnimation::create("farmer.plist", 0.2f, 2.0f, Vec2(200, 200));
	this->addChild(ch, 50);
	ch->Move(1);
	return true;
}
...
bool VillageMap::init()
{
	...
	/*
	this->tree[0] = Plant::create("Plantsource/tree1_spring.png", "Plantsource/tree1_summer.png", "Plantsource/tree1_fall.png", "Plantsource/tree1_winter.png");
	this->tree[0]->setAnchorPoint(Vec2(0.5, 0));
	this->tree[0]->setScale(1.4f);
	...
	treebody1->setDynamic(false);
	this->tree[1] = Plant::create("Plantsource/tree2_spring.png", "Plantsource/tree2_summer.png", "Plantsource/tree2_fall.png", "Plantsource/tree2_winter.png");
	this->tree[1]->setAnchorPoint(Vec2(0.5, 0));
	this->tree[1]->setScale(2.0f);
	this->tree[1]->setPosition(Vec2(325, 143));
	...
	this->tree[2] = Plant::create("Plantsource/tree1_spring.png", "Plantsource/tree1_summer.png", "Plantsource/tree1_fall.png", "Plantsource/tree1_winter.png");
	this->tree[2]->setAnchorPoint(Vec2(0.5, 0));
	this->tree[2]->setScale(1.4f);
	this->tree[2]->setPosition(Vec2(1827, 154));
	...
	this->tree[3] = Plant::create("Plantsource/tree2_spring.png", "Plantsource/tree2_summer.png", "Plantsource/tree2_fall.png", "Plantsource/tree2_winter.png");
	this->tree[3]->setAnchorPoint(Vec2(0.5, 0));
	this->tree[3]->setScale(2.0f);
	...
	this->tree[4] = Plant::create("Plantsource/tree1_spring.png", "Plantsource/tree1_summer.png", "Plantsource/tree1_fall.png", "Plantsource/tree1_winter.png");
	this->tree[4]->setAnchorPoint(Vec2(0.5, 0));
	this->tree[4]->setScale(1.4f);
	this->tree[4]->setPosition(Vec2(244, 475));
	...
	this->tree[5] = Plant::create("Plantsource/tree2_spring.png", "Plantsource/tree2_summer.png", "Plantsource/tree2_fall.png", "Plantsource/tree2_winter.png");
	this->tree[5]->setAnchorPoint(Vec2(0.5, 0));
	this->tree[5]->setScale(2.0f);
	...
	this->tree[6] = Plant::create("Plantsource/tree1_spring.png", "Plantsource/tree1_summer.png", "Plantsource/tree1_fall.png", "Plantsource/tree1_winter.png");
	this->tree[6]->setAnchorPoint(Vec2(0.5, 0));
	this->tree[6]->setScale(1.4f);
	...
	this->tree[7] = Plant::create("Plantsource/tree2_spring.png", "Plantsource/tree2_summer.png", "Plantsource/tree2_fall.png", "Plantsource/tree2_winter.png");
	this->tree[7]->setAnchorPoint(Vec2(0.5, 0));
	this->tree[7]->setScale(2.0f);
